...
macro(find_VTK)
  if(PCL_ALL_IN_ONE_INSTALLER AND NOT ANDROID)
    if(EXISTS "${PCL_ROOT}/3rdParty/VTK/lib/cmake")
      ...
      set(VTK_DIR "${PCL_ROOT}/3rdParty/VTK/lib/vtk-6.2")
    endif()
  ...
  if(NOT ANDROID)
    ...
    if (VTK_FOUND)
      set(VTK_LIBRARIES "/usr/lib/x86_64-linux-gnu/libtiff.so;/usr/lib/x86_64-linux-gnu/libjpeg.so;/usr/lib/x86_64-linux-gnu/libz.so;vtkParallelMPI4Py;vtkParallelMPI;vtkParallelCore;vtkCommonCore;vtksys;vtkIOLegacy;vtkCommonDataModel;vtkCommonMath;vtkCommonMisc;vtkCommonSystem;vtkCommonTransforms;vtkIOCore;vtkCommonExecutionModel;/usr/lib/x86_64-linux-gnu/libpython2.7.so;vtkftgl;/usr/lib/x86_64-linux-gnu/libfreetype.so;vtkGUISupportQtWebkit;vtkViewsQt;vtkGUISupportQt;vtkFiltersExtraction;vtkFiltersCore;vtkFiltersGeneral;vtkCommonComputationalGeometry;vtkFiltersStatistics;vtkImagingFourier;vtkImagingCore;vtkalglib;vtkInteractionStyle;vtkFiltersSources;vtkRenderingCore;vtkCommonColor;vtkFiltersGeometry;vtkRenderingOpenGL;vtkImagingHybrid;vtkIOImage;vtkDICOMParser;vtkmetaio;/usr/lib/x86_64-linux-gnu/libpng.so;vtkViewsInfovis;vtkChartsCore;vtkInfovisCore;vtkRenderingContext2D;vtkRenderingFreeType;vtkFiltersImaging;vtkImagingGeneral;vtkImagingSources;vtkFiltersModeling;vtkInfovisLayout;vtkRenderingLabel;vtkViewsCore;vtkInteractionWidgets;vtkFiltersHybrid;vtkRenderingAnnotation;vtkImagingColor;vtkRenderingVolume;vtkFiltersFlowPaths;vtkIOInfovis;vtkIOXML;vtkIOGeometry;/usr/lib/x86_64-linux-gnu/libjsoncpp.so;vtkIOXMLParser;/usr/lib/x86_64-linux-gnu/libexpat.so;/usr/lib/x86_64-linux-gnu/libxml2.so;vtkTestingIOSQL;vtkIOSQL;sqlite3;vtkIONetCDF;/usr/lib/x86_64-linux-gnu/libnetcdf_c++.so;/usr/lib/x86_64-linux-gnu/libnetcdf.so;/usr/lib/x86_64-linux-gnu/hdf5/openmpi/lib/libhdf5.so;/usr/lib/x86_64-linux-gnu/libsz.so;/usr/lib/x86_64-linux-gnu/libdl.so;/usr/lib/x86_64-linux-gnu/libm.so;/usr/lib/x86_64-linux-gnu/hdf5/openmpi/lib/libhdf5_hl.so;/usr/lib/openmpi/lib/libmpi.so;vtkIOAMR;vtkFiltersAMR;vtkIOPLY;vtkFiltersHyperTree;vtkFiltersProgrammable;vtkRenderingFreeTypeOpenGL;vtkFiltersSMP;vtkRenderingMatplotlib;vtkPythonInterpreter;vtkWrappingPythonCore;vtkWrappingTools;vtkIOParallelExodus;vtkIOExodus;vtkexoIIc;vtkFiltersTexture;/usr/lib/libgl2ps.so;vtkInfovisBoostGraphAlgorithms;vtkIOMySQL;vtkDomainsChemistry;vtkFiltersParallelGeometry;vtkRenderingContextOpenGL;vtkRenderingQt;vtkTestingGenericBridge;vtkImagingStatistics;vtkIOVPIC;VPIC;vtkIOMPIImage;vtkIOParallelLSDyna;vtkIOLSDyna;vtkInteractionImage;vtkFiltersGeneric;vtkRenderingFreeTypeFontConfig;vtkFiltersParallelFlowPaths;vtkGUISupportQtSQL;vtkIOEnSight;vtkRenderingLOD;vtkGUISupportQtOpenGL;vtkFiltersReebGraph;vtkImagingMath;vtkTestingRendering;vtkRenderingVolumeOpenGL;vtkIOExport;vtkRenderingGL2PS;vtkIOODBC;vtkFiltersParallelImaging;vtkFiltersParallel;vtkRenderingExternal;vtkFiltersVerdict;verdict;/usr/lib/x86_64-linux-gnu/libtheoraenc.so;/usr/lib/x86_64-linux-gnu/libtheoradec.so;/usr/lib/x86_64-linux-gnu/libogg.so;vtkIOVideo;vtkIOGeoJSON;vtkWrappingJava;vtkIOImport;vtkproj4;vtkIOParallelXML;vtkFiltersParallelStatistics;vtkIOXdmf2;vtkxdmf2;vtkFiltersPython;vtkImagingStencil;vtkRenderingParallel;vtkLocalExample;vtkIOParallel;vtkGeovisCore;vtkIOParallelNetCDF;vtkViewsGeovis;vtkViewsContext2D;vtkFiltersParallelMPI;vtkImagingMorphological;vtkIOMPIParallel;vtkIOMovie;vtkIOFFMPEG;vtkFiltersSelection;vtkIOMINC;vtkIOGDAL;vtkRenderingImage;vtkIOPostgreSQL;vtkRenderingParallelLIC;vtkRenderingLIC")
    endif(VTK_FOUND)
  endif()
endmacro(find_VTK)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/elliottwhite/turtlebot2_wss/extern/src/pcl-pcl-1.8.0")
...
set(pcl_all_components  common octree io kdtree search sample_consensus filters 2d features geometry keypoints surface registration ml segmentation recognition visualization people outofcore tracking stereo )
