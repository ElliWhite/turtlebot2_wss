...
public:
    ...
    PointCloudRGBCombiner(ros::NodeHandle nh): nh_(nh) // ,colored_pcl_in(0L)
    {
        ...
        image_topic = getParam<std::string>(nh_, "image_topic", "/rgb/image_rect_color"); 
        pcl_topic = getParam<std::string>(nh_, "pcl_topic", "/depth/pcd");
        pcd_color_topic = getParam<std::string>(nh_, "pcd_color_topic", "/depth/pcd_colored");
        pcd_rect_topic = getParam<std::string>(nh_, "pcd_rect_topic", "/depth/pcd_rect");
