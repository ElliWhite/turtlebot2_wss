...
if("TRUE" STREQUAL "TRUE")
  set(minkindr_conversions_SOURCE_PREFIX /home/elliottwhite/turtlebot2_wss/laser_slam_ws/src/minkindr_ros/minkindr_conversions)
  set(minkindr_conversions_DEVEL_PREFIX /home/elliottwhite/turtlebot2_wss/laser_slam_ws/devel)
  ...
  set(minkindr_conversions_INSTALL_PREFIX /home/elliottwhite/turtlebot2_wss/laser_slam_ws/install)
...
if(NOT "/home/elliottwhite/turtlebot2_wss/laser_slam_ws/src/minkindr_ros/minkindr_conversions/include " STREQUAL " ")
  set(minkindr_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/elliottwhite/turtlebot2_wss/laser_slam_ws/src/minkindr_ros/minkindr_conversions/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'minkindr_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/elliottwhite/turtlebot2_wss/laser_slam_ws/src/minkindr_ros/minkindr_conversions/${idir}'.  ${_report}")
    endif()
