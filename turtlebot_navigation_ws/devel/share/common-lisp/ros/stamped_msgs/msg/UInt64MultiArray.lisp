...
(cl:defmethod cl:initialize-instance :after ((m <UInt64MultiArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UInt64MultiArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<UInt64MultiArray> is deprecated: use stamped_msgs-msg:UInt64MultiArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <UInt64MultiArray>))
