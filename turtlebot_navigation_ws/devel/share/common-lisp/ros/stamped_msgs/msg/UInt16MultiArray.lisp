...
(cl:defmethod cl:initialize-instance :after ((m <UInt16MultiArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UInt16MultiArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<UInt16MultiArray> is deprecated: use stamped_msgs-msg:UInt16MultiArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <UInt16MultiArray>))
