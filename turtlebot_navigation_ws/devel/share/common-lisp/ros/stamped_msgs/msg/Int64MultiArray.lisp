...
(cl:defmethod cl:initialize-instance :after ((m <Int64MultiArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Int64MultiArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<Int64MultiArray> is deprecated: use stamped_msgs-msg:Int64MultiArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Int64MultiArray>))
