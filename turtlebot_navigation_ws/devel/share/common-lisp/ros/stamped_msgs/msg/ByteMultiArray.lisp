...
(cl:defmethod cl:initialize-instance :after ((m <ByteMultiArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ByteMultiArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<ByteMultiArray> is deprecated: use stamped_msgs-msg:ByteMultiArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ByteMultiArray>))
