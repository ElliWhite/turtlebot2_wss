...
(cl:defmethod cl:initialize-instance :after ((m <UInt8MultiArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UInt8MultiArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<UInt8MultiArray> is deprecated: use stamped_msgs-msg:UInt8MultiArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <UInt8MultiArray>))
