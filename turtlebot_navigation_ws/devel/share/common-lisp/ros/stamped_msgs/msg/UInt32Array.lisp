...
(cl:defmethod cl:initialize-instance :after ((m <UInt32Array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UInt32Array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<UInt32Array> is deprecated: use stamped_msgs-msg:UInt32Array instead.")))
