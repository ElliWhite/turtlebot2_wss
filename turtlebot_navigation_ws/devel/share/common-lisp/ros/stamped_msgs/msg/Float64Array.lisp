...
(cl:defmethod cl:initialize-instance :after ((m <Float64Array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float64Array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<Float64Array> is deprecated: use stamped_msgs-msg:Float64Array instead.")))
