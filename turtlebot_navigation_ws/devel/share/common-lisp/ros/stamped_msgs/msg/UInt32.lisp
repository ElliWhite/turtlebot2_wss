...
(cl:defmethod cl:initialize-instance :after ((m <UInt32>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UInt32)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<UInt32> is deprecated: use stamped_msgs-msg:UInt32 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <UInt32>))
