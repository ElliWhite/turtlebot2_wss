...
(cl:defmethod cl:initialize-instance :after ((m <BoolArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoolArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name stamped_msgs-msg:<BoolArray> is deprecated: use stamped_msgs-msg:BoolArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <BoolArray>))
