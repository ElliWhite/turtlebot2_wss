...
(cl:defmethod cl:initialize-instance :after ((m <networkerrors>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'networkerrors)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wireless_network_msgs-msg:<networkerrors> is deprecated: use wireless_network_msgs-msg:networkerrors instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <networkerrors>))
...
(cl:defmethod retransmits-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:retransmits-val is deprecated.  Use wireless_network_msgs-msg:retransmits instead.")
  (retransmits m))

(cl:ensure-generic-function 'badsegments-val :lambda-list '(m))
(cl:defmethod badsegments-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:badsegments-val is deprecated.  Use wireless_network_msgs-msg:badsegments instead.")
  (badsegments m))

(cl:ensure-generic-function 'udperrors-val :lambda-list '(m))
(cl:defmethod udperrors-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:udperrors-val is deprecated.  Use wireless_network_msgs-msg:udperrors instead.")
  (udperrors m))

(cl:ensure-generic-function 'tx_retires-val :lambda-list '(m))
(cl:defmethod tx_retires-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:tx_retires-val is deprecated.  Use wireless_network_msgs-msg:tx_retires instead.")
  (tx_retires m))

(cl:ensure-generic-function 'rx_dropped-val :lambda-list '(m))
(cl:defmethod rx_dropped-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:rx_dropped-val is deprecated.  Use wireless_network_msgs-msg:rx_dropped instead.")
  (rx_dropped m))

(cl:ensure-generic-function 'nic_tx_errors-val :lambda-list '(m))
(cl:defmethod nic_tx_errors-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:nic_tx_errors-val is deprecated.  Use wireless_network_msgs-msg:nic_tx_errors instead.")
  (nic_tx_errors m))

(cl:ensure-generic-function 'nic_rx_errors-val :lambda-list '(m))
(cl:defmethod nic_rx_errors-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:nic_rx_errors-val is deprecated.  Use wireless_network_msgs-msg:nic_rx_errors instead.")
  (nic_rx_errors m))

(cl:ensure-generic-function 'nic_tx_dropped-val :lambda-list '(m))
(cl:defmethod nic_tx_dropped-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:nic_tx_dropped-val is deprecated.  Use wireless_network_msgs-msg:nic_tx_dropped instead.")
  (nic_tx_dropped m))

(cl:ensure-generic-function 'nic_rx_dropped-val :lambda-list '(m))
(cl:defmethod nic_rx_dropped-val ((m <networkerrors>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wireless_network_msgs-msg:nic_rx_dropped-val is deprecated.  Use wireless_network_msgs-msg:nic_rx_dropped instead.")
  (nic_rx_dropped m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<networkerrors>)))
  ...
  "wireless_network_msgs/networkerrors")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'networkerrors)))
  "Returns string type for a message object of type 'networkerrors"
  "wireless_network_msgs/networkerrors")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<networkerrors>)))
  ...
  "235edb359781a06294f8b29034894b78")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'networkerrors)))
  "Returns md5sum for a message object of type 'networkerrors"
  "235edb359781a06294f8b29034894b78")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<networkerrors>)))
  ...
  (cl:format cl:nil "Header header~%~%#segment errors at (tcp) protocol level~%int64 retransmits~%int64 badsegments~%~%#errors in udp transmission~%int64 udperrors~%~%#system level (MAC layer) errors~%int64 tx_retires~%int64 rx_dropped~%~%~%#interface level (NIC statistics) errors~%int64 nic_tx_errors~%int64 nic_rx_errors~%int64 nic_tx_dropped~%int64 nic_rx_dropped~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'networkerrors)))
  "Returns full string definition for message of type 'networkerrors"
  (cl:format cl:nil "Header header~%~%#segment errors at (tcp) protocol level~%int64 retransmits~%int64 badsegments~%~%#errors in udp transmission~%int64 udperrors~%~%#system level (MAC layer) errors~%int64 tx_retires~%int64 rx_dropped~%~%~%#interface level (NIC statistics) errors~%int64 nic_tx_errors~%int64 nic_rx_errors~%int64 nic_tx_dropped~%int64 nic_rx_dropped~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
