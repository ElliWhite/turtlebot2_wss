...
;//! \htmlinclude FlippersStateStamped.msg.html

(cl:defclass <FlippersStateStamped> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass FlippersStateStamped (<FlippersStateStamped>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <FlippersStateStamped>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'FlippersStateStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nifti_robot_driver_msgs-msg:<FlippersStateStamped> is deprecated: use nifti_robot_driver_msgs-msg:FlippersStateStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <FlippersStateStamped>))
...
(cl:defmethod frontLeft-val ((m <FlippersStateStamped>))
...
(cl:defmethod frontRight-val ((m <FlippersStateStamped>))
...
(cl:defmethod rearLeft-val ((m <FlippersStateStamped>))
...
(cl:defmethod rearRight-val ((m <FlippersStateStamped>))
  ...
  (rearRight m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <FlippersStateStamped>) ostream)
  "Serializes a message object of type '<FlippersStateStamped>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <FlippersStateStamped>) istream)
  "Deserializes a message object of type '<FlippersStateStamped>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FlippersStateStamped>)))
  "Returns string type for a message object of type '<FlippersStateStamped>"
  "nifti_robot_driver_msgs/FlippersStateStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FlippersStateStamped)))
  "Returns string type for a message object of type 'FlippersStateStamped"
  "nifti_robot_driver_msgs/FlippersStateStamped")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FlippersStateStamped>)))
  "Returns md5sum for a message object of type '<FlippersStateStamped>"
  "88a446f832904937708e487c974640d3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FlippersStateStamped)))
  "Returns md5sum for a message object of type 'FlippersStateStamped"
  "88a446f832904937708e487c974640d3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FlippersStateStamped>)))
  "Returns full string definition for message of type '<FlippersStateStamped>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FlippersStateStamped)))
  "Returns full string definition for message of type 'FlippersStateStamped"
  (cl:format cl:nil "Header header~%float64 frontLeft~%float64 frontRight~%float64 rearLeft~%float64 rearRight~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <FlippersStateStamped>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <FlippersStateStamped>))
  "Converts a ROS message object to a list"
  (cl:list 'FlippersStateStamped
