...
class RequestRSS_Publish_PCRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RequestRSS_Publish_PCRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RequestRSS_Publish_PCRequest
    let len;
    let data = new RequestRSS_Publish_PCRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RequestRSS_Publish_PCRequest(null);
...
class RequestRSS_Publish_PCResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.status = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RequestRSS_Publish_PCResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RequestRSS_Publish_PCResponse
    let len;
    let data = new RequestRSS_Publish_PCResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RequestRSS_Publish_PCResponse(null);
...
module.exports = {
  Request: RequestRSS_Publish_PCRequest,
  Response: RequestRSS_Publish_PCResponse,
  md5sum() { return 'be35b97a626a98d93d3670b842cadba3'; },
  datatype() { return 'wireless_network_msgs/RequestRSS_Publish_PC'; }
};
