...
class pingactionActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = pingactionGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new pingactionActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = pingactionGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new pingactionGoal()
    }
...
module.exports = pingactionActionGoal;
