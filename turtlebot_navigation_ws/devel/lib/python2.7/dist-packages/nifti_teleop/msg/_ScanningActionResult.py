...
"""autogenerated by genpy from nifti_teleop/ScanningActionResult.msg. Do not edit."""
import sys
...
class ScanningActionResult(genpy.Message):
  _md5sum = "163f2e0aa6e492d44f614ae7ee3c8b90"
  _type = "nifti_teleop/ScanningActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nifti_teleop/ScanningResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = nifti_teleop.msg.ScanningResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = nifti_teleop.msg.ScanningResult()
