...
"""autogenerated by genpy from nifti_teleop/ScanningActionFeedback.msg. Do not edit."""
import sys
...
class ScanningActionFeedback(genpy.Message):
  _md5sum = "14b43326a98680c73f99ae08574f4bb6"
  _type = "nifti_teleop/ScanningActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','nifti_teleop/ScanningFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = nifti_teleop.msg.ScanningFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = nifti_teleop.msg.ScanningFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_b().pack(self.feedback.status))
