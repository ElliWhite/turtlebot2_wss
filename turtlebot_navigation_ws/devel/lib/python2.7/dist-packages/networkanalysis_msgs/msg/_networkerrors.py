...
"""autogenerated by genpy from networkanalysis_msgs/networkerrors.msg. Do not edit."""
import sys
...
class networkerrors(genpy.Message):
  _md5sum = "00505f88cd05dc9219c740b79985fc84"
  _type = "networkanalysis_msgs/networkerrors"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """#segment errors at (tcp) protocol level
int64 retransmits
int64 badsegments
...
"""
  __slots__ = ['retransmits','badsegments','udperrors','tx_retires','rx_dropped','nic_tx_errors','nic_rx_errors','nic_tx_dropped','nic_rx_dropped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       retransmits,badsegments,udperrors,tx_retires,rx_dropped,nic_tx_errors,nic_rx_errors,nic_tx_dropped,nic_rx_dropped
