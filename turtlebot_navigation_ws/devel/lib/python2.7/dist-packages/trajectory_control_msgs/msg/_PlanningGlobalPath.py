...
"""autogenerated by genpy from trajectory_control_msgs/PlanningGlobalPath.msg. Do not edit."""
import sys
...
class PlanningGlobalPath(genpy.Message):
  _md5sum = "bcb6b89f087c9569c38f6953756f6de0"
  _type = "trajectory_control_msgs/PlanningGlobalPath"
...
float64 w
"""
  __slots__ = ['header','name','task_id','type','waypoints','path']
  _slot_types = ['std_msgs/Header','string','int32','uint8','geometry_msgs/Point[]','nav_msgs/Path']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,task_id,type,waypoints,path
    ...
    """
    if args or kwds:
      super(PlanningGlobalPath, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_iB().pack(_x.task_id, _x.type))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.task_id, _x.type,) = _get_struct_iB().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.waypoints = []
