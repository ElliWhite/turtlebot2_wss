...
"""autogenerated by genpy from trajectory_control_msgs/PathPlanningRequest.msg. Do not edit."""
import sys
...
class PathPlanningRequest(genpy.Message):
  ...
  _type = "trajectory_control_msgs/PathPlanningRequest"
...
def _get_struct_7d3I():
    ...
    return _struct_7d3I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from trajectory_control_msgs/PathPlanningResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PathPlanningResponse(genpy.Message):
  _md5sum = "c9fbdaf79532fff8047bcc60a4b7536e"
  _type = "trajectory_control_msgs/PathPlanningResponse"
  _has_header = False #flag to mark the presence of a Header object
...
float64 w
"""
  __slots__ = ['success','path','path_cost']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3I().pack(_x.success, _x.path.header.seq, _x.path.header.stamp.secs, _x.path.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.success, _x.path.header.seq, _x.path.header.stamp.secs, _x.path.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
...
class PathPlanning(object):
  _type          = 'trajectory_control_msgs/PathPlanning'
  _md5sum = '249cbd5d21a9bf348c5b7b36bffd0e9e'
