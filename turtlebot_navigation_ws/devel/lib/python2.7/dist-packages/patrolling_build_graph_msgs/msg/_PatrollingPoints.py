...
"""autogenerated by genpy from patrolling_build_graph_msgs/PatrollingPoints.msg. Do not edit."""
import sys
...
class PatrollingPoints(genpy.Message):
  _md5sum = "68b0d4ab8a0fa82167176f3fbbfcc122"
  _type = "patrolling_build_graph_msgs/PatrollingPoints"
...
float64 z
"""
  __slots__ = ['header','num_nodes','node_id','node_position','node_priority']
  _slot_types = ['std_msgs/Header','uint32','uint32[]','geometry_msgs/Point[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,num_nodes,node_id,node_position,node_priority
    ...
    """
    if args or kwds:
      super(PatrollingPoints, self).__init__(*args, **kwds)
