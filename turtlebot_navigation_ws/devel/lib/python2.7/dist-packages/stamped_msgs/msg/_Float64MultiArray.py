...
"""autogenerated by genpy from stamped_msgs/Float64MultiArray.msg. Do not edit."""
import sys
...
class Float64MultiArray(genpy.Message):
  _md5sum = "467de01f1ba7b798b8092f52c7a315ff"
  _type = "stamped_msgs/Float64MultiArray"
...
uint32 stride  # stride of given dimension"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_Id().pack(_x.layout.data_offset, _x.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.layout.data_offset, _x.data,) = _get_struct_Id().unpack(str[start:end])
      return self
